...
class RdfConverter(Converter):
    ...
    with open(CUR_ABS_DIR / "../symbols/rdf_classes.json") as classes_file:
        CLASSES = json.load(classes_file)
        CLASSES_INV = {v: k for k, v in CLASSES.items()}

    with open(CUR_ABS_DIR / "../symbols/rdf_function_classes.json") as function_classes_file:
    ...
    TERMINAL = URIRef(
        "https://www.wikidata.org/wiki/Q947546")  # https://www.wikidata.org/wiki/Q2443617")  # <-Port  Terminal (Conflicing Node Class) -> "https://www.wikidata.org/wiki/Q182610"
