"""laoder.py: Abstract Base Class for Cached Loader"""
...
class Dataloader(ABC):
    ...
    def _cache_exists(self):
        ...
        return isfile(CUR_ABS_DIR / f"../../loaders/{self._create_signature()}")
    ...
    def _create_cache(self) -> None:
        ...
        save(self._samples, CUR_ABS_DIR / f"../../loaders/{self._create_signature()}")
        print("OK")


    def _load_cache(self) -> None:

        self._samples = load(CUR_ABS_DIR / f"../../loaders/{self._create_signature()}")
